...
import type { AppGetState, AppDispatch } from "../redux/getStore.js"
...
export const bringBackDoc = (identifier: string) => (dispatch: AppDispatch, getState: AppGetState) => {
